...
/***/ (function(module, exports, __webpack_require__) {
	...
	(0, _jquery2['default'])('.html-inspector').append($inspectorButton);
	
	(0, _jquery2['default'])('.html-inspector').mouseenter(function () {
	  (0, _jquery2['default'])(this).find('.inspector-button').addClass('visible');
	});
	(0, _jquery2['default'])('.html-inspector').mouseleave(function () {
	  (0, _jquery2['default'])(this).find('.inspector-button').removeClass('visible');
	});
	
	(0, _jquery2['default'])('.inspector-button').on('click', function () {
	  var $that = (0, _jquery2['default'])(this).parent()[0];
	  var $this = (0, _jquery2['default'])('.main__inspector .inspector-content code');

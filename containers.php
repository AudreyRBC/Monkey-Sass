...
<section class="container-columns__full bg-darkgrey ptb80 html-inspector" style="background-image:url(dist/images/overlay.jpg); background-blend-mode: soft-light">
  ...
  <section class="small-column-1-1 large-column-3-5 flex-col vertical-center">
    <div class="container__large-center table left">
      <h2 class="left">.container-columns__full.table</h2>
      <ul class="table__list">
        <li class="border-bottom">
          <a class="flex-row" href="#">
            <div class="container-image small-column-1-5">
              <span>65x65</span>
            </div>
            <div class="container-content small-column-4-5">
              <span class="p-small grey">.p-small.grey</span>
              <h3 class="p-regular bold">.p-regular.bold</h3>
            </div>
          </a>
        </li>
        <li class="border-bottom">
      ...
      <div class="flex space-between vertical-center mt100">
